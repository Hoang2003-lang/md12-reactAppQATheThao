        ...
        <View style={styles.container}>
            ...
            <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 40 }}>
                ...
                <Text style={styles.text}>
                    F7 Shop thu thập dữ liệu cá nhân nhằm mục đích xác nhận đơn hàng, giao hàng, liên hệ hỗ trợ khách hàng và gửi thông tin khuyến mãi nếu người dùng đồng ý.
                </Text>
                ...
                <Text style={styles.text}>
                    ...
                    - F7 Shop cam kết không bán, trao đổi hay chia sẻ thông tin khách hàng cho bên thứ ba mà không có sự đồng ý từ bạn, trừ khi có yêu cầu pháp lý.
                </Text>
